...
// Generate time: 2017/12/13 11:20:08
...
//  source: ./src/api/api.cc:113
int face_init(GlobalConfig* config);

//  source: ./src/api/api.cc:267
int face_ping_pong(int ping);

//  source: ./src/api/api.cc:108
void face_set_init_flag(int flag);

//  source: ./src/api/api.cc:254
...
// md5sum:
// 0836792176be75043e2a6c5c668ef3e9  ./src/api/api.cc
