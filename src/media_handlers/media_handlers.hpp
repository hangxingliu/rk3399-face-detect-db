...
// Generate time: 2017/12/04 18:21:53
...
//  source: ./src/media_handlers/capture.cc:80
int Capture_Init();

//  source: ./src/media_handlers/capture.cc:37
void physicalCaptureDeviceToString(char* result, PhysicalCaptureDevice* dev, bool markAsUse);

#endif

// md5sum:
// a4f8f26071abf4bd24c8806e299d541e  ./src/media_handlers/capture.cc
