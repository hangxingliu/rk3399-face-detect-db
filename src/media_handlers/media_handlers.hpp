...
//  ====================
//  @file ./src/media_handlers/capture.cc
//  ====================

//  source: ./src/media_handlers/capture.cc:103
int Capture_Init();

//  source: ./src/media_handlers/capture.cc:197
int Capture_Read(cv::Mat* frame);

//  source: ./src/media_handlers/capture.cc:24
void Capture_enableUnitTest();

//  source: ./src/media_handlers/capture.cc:46
void physicalCaptureDeviceToString(char* result, PhysicalCaptureDevice* dev, bool markAsUse);

#endif

// md5sum:
// a42c92b3e28770bc56f9054afc7dcd94  ./src/media_handlers/capture.cc
