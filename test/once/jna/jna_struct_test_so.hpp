...
// Generate time: 2017/12/13 11:09:05
...
//  ====================
//  @file ./test/once/jna/jna_struct_test_so.cc
//  ====================

//  source: ./test/once/jna/jna_struct_test_so.cc:48
void disposePointsInPath(Path* path);

//  source: ./test/once/jna/jna_struct_test_so.cc:11
void dumpRect1(Rect1* r);

//  source: ./test/once/jna/jna_struct_test_so.cc:18
void dumpRect2(Rect2* r);

//  source: ./test/once/jna/jna_struct_test_so.cc:24
void getRectPathWay1(Path* pathInitedPoints);

//  source: ./test/once/jna/jna_struct_test_so.cc:36
void getRectPathWay2(Path* pathWithoutInit);

//  source: ./test/once/jna/jna_struct_test_so.cc:53
int main();
...
// md5sum:
// bfd8400a26b7af5c2f27d450b55662f2  ./test/once/jna/jna_struct_test_so.cc
