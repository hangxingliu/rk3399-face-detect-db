...
// Generate time: 2017/12/06 07:01:16
...
//  source: ./test/utils/index.cc:34
int testCompareStrings(const char* s1, const char* s2);

//  source: ./test/utils/index.cc:29
int testDone(const char* description);

//  source: ./test/utils/index.cc:19
int testFailed(const char* description);

//  source: ./test/utils/index.cc:24
int testPassed(const char* description);

#endif

// md5sum:
// 9f72da08f776f767f97d70fb6fb4a636  ./test/utils/index.cc
