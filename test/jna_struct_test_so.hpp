...
//  source: ./test/jna_struct_test_so.cc:45
void disposePointsInPath(Path* path);

//  source: ./test/jna_struct_test_so.cc:8
void dumpRect1(Rect1* r);

//  source: ./test/jna_struct_test_so.cc:15
void dumpRect2(Rect2* r);

//  source: ./test/jna_struct_test_so.cc:21
void getRectPathWay1(Path* pathInitedPoints);

//  source: ./test/jna_struct_test_so.cc:33
void getRectPathWay2(Path* pathWithoutInit);

//  source: ./test/jna_struct_test_so.cc:50
int main();
...
// md5sum:
// 9620e1708fbc485badc2e253bbb8d81b  ./test/jna_struct_test_so.cc
